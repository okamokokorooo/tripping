...
class ProgramsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create program" do
    assert_difference('Program.count') do
      post programs_url, params: { program: { title: @program.title, user_id: @program.user_id } }
    end
  ...
  test "should update program" do
    patch program_url(@program), params: { program: { title: @program.title, user_id: @program.user_id } }
